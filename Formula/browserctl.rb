...
class Browserctl < Formula
  ...
  bottle do
    ...
    rebuild 3
    sha256 cellar: :any, arm64_sequoia: "68feb79a6f7f90658a0096febdd6acde6edcbd182aae9475bf867e3d5a970383"
  end
  ...
  def install
    ...
    env = { GEM_HOME: libexec, GEM_PATH: libexec, PATH: "#{Formula["ruby"].opt_bin}#{File::PATH_SEPARATOR}#{ENV["PATH"]}" }
