...
class Textus < Formula
  ...
  url "https://github.com/patrick204nqh/textus/archive/refs/tags/v0.51.0.tar.gz"
  ...
  bottle do
    ...
    sha256 cellar: :any, arm64_sequoia: "04efbba0a9e12e0a257fecefda6caf6a7ce47d44846588a2ee103db072c2caa5"
  end
